if Code.ensure_loaded?(Plug) do
  defmodule Anubis.Server.Authorization.WellKnown do
    ...
    This plug is automatically handled by
    `Anubis.Server.Transport.StreamableHTTP.Plug` when authorization is
    configured. It can also be mounted independently in a Phoenix router or
    Plug pipeline.
