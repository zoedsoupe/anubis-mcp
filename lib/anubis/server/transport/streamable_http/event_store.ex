defmodule Anubis.Server.Transport.StreamableHTTP.EventStore do
  ...
  adapter can genuinely fail here. The transport logs the failure rather than
  reporting a clean teardown while replayable data may still remain in the store.
  """
